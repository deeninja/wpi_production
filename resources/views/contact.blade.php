    ...
    <!-- /.notifications -->
        <div class="col-lg-offset-2 col-lg-10">
            ...
            @include('includes.form_error')
                <!-- contact form -->
                <form class="contact-form form-horizontal" action="{{url('/contact')}}" method="POST"
                      id="contact_form">
                {{csrf_field()}}
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <div class="pull-left form-warning-msg"><span id="name-warning"></span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <div class="pull-left form-warning-msg"><span id="email-warning"></span></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <input name="subject" id="subject-field" placeholder="Subject" class="form-control"
                                       type="text">
                                <div class="pull-left form-warning-msg"><span id="subject-warning"></span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <div class="pull-left form-warning-msg"><span id="msg-warning"></span></div>
                            </div>
                        </div>
                    </div>
